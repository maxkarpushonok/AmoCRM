<?php
    ...
    $user = array(
        'USER_LOGIN' => 'mazqazasd@outlook.com', //Ваш логин (электронная почта)
        'USER_HASH' => '112f8e19ebf782451171efff26b1b071c65b2bbd', //Хэш для доступа к API (смотрите в профиле пользователя)
    );

    $subdomain = 'mazqazasd'; //Наш аккаунт - поддомен
